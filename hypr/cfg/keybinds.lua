...
hl.bind(mainMod .. " + left",  hl.dsp.window.resize({ x = -20, y = 0, relative }))
hl.bind(mainMod .. " + right", hl.dsp.window.resize({ x = 20, y = 0, relative }))
hl.bind(mainMod .. " + up",    hl.dsp.window.resize({ x = 0, y = -20, relative }))
hl.bind(mainMod .. " + down",  hl.dsp.window.resize({ x = 0, y = 20, relative }))
